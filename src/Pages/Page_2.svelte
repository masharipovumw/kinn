      ...
      <table border="1">
        ...
        <tbody>
          {#each calculatedData as row}
            <tr>
              <td>{row.Year}</td>
              <td>{typeof row.X === 'number' ? row.X.toFixed(2) : 'Invalid'}</td>
              <td>{typeof row.Y === 'number' ? row.Y.toFixed(2) : 'Invalid'}</td>
              <td>{typeof row.XY === 'number' ? row.XY.toFixed(2) : 'Invalid'}</td>
              <td>{typeof row.X2 === 'number' ? row.X2.toFixed(2) : 'Invalid'}</td>
            </tr>
          {/each}
        </tbody>
      </table>
